...
exports.resizeTourImages = async(req, res, next) => { // Transforma las imagenes a un formato y tamaño predeterminado
    ...
    await Promise.all(
        req.files.images.map(async(file, i) => {
            ...
            await sharp(file.buffer).resize(2000, 1333).toFormat('jpeg').jpeg({ quality: 100 }).toFile(`public/img/tours/${filename}`);
